...
class MeetingController < ApplicationController
    def home
        ...
        response = HTTParty.get(getRecordingLink, verify: true, timeout: 60)
    ...
    def create
        ...
        response = HTTParty.get(createLink, verify: true, timeout: 60)
    ...
    def delete
        ...
        response = HTTParty.get(deleteLink, verify: true, timeout: 60)
        redirect_to "/"
    end
